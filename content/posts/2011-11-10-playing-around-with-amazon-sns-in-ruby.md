...
Slug: 2011/11/10/playing-around-with-amazon-sns-in-ruby
Save_as: 2011/11/10/playing-around-with-amazon-sns-in-ruby/index.html
URL: 2011/11/10/playing-around-with-amazon-sns-in-ruby/
Tags: Amazon, AWS, Howto, Ruby, SNS
Summary: Ruby example using Amazon Web Services SDK to publish messages to Simple Notification Service topics. Demonstrates getting SNS interface, finding topic by ARN, and publishing messages which can be delivered as SMS or emails, perfect for form-based notifications in Ruby applications.

For an upcoming Ruby project that I plan on working on I want to be able to send small messages to myself with information from a form that gets filled out. Amazon has just updated Simple Notification Service to be able to send SMS messages along with emails. This fits in perfectly with what I'm looking for. Looking on Amazon's GitHub page for the aws-sdk gem I didn't see any sample code for using SNS, and googling I couldn't find any right away. As I needed to learn this anyway, I decided to make my own sample code, which I hope to get into the official repository with a pull request soon. After looking at the documentation and the source code for the library I was able to work this out.
