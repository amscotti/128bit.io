...
Slug: 2012/04/01/using-redis-to-sort-world-of-warcrafts-auction-house-data
Save_as: 2012/04/01/using-redis-to-sort-world-of-warcrafts-auction-house-data/index.html
URL: 2012/04/01/using-redis-to-sort-world-of-warcrafts-auction-house-data/
Tags: API, Howto, JSON, Redis, Ruby, Wow, YAJL
Summary: Demonstrates using Redis as an in-memory data store for sorting World of Warcraft auction house data retrieved from Battle.net API. Uses YAJL for fast JSON parsing, stores auction data in Redis sorted sets for quick lookup by item, and showcases Redis alongside MongoDB in NoSQL applications.
